        ...
        <div class="row">
            <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                    <div class="x_content">
                        <!-- start project list -->
                        <form method="post" action="/index.php/dataFunction/modBoard">
                            ...
                            <table class="table table-striped jambo_table bulk_action board_table">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td colspan="2">
                                            <textarea name="contents" class="form-control" placeholder="내용을 입력해주세요." required><?= $info->CONTENTS ?></textarea>
                                        </td>
                                    </tr>
                                </tbody>
                            </table>
                            <button type="button" class="btn btn-warning" onclick="location.href = '/index/board_view/<?= $this->uri->segment(3) ?>/<?= $this->uri->segment(4) ?>/<?= $this->uri->segment(5) ?>/<?= $this->uri->segment(6) ?>'">취소</button>
