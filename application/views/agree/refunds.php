        ...
        <div class="row">
            <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                    <div class="x_content">
                        <!-- start project list -->
                        <form method="post" action="/index.php/dataFunction/modRefunds">
                                    ...
                                    <tr>
                                        <td colspan="2">
                                            <?php //if ($this->session->userdata('BRANCH_IDX') === '1') { ?>
                                                <textarea name="refunds" class="form-control" placeholder="내용을 입력해주세요." required><?= $info->REFUNDS ?></textarea>
                                            <?php //} else { ?>
